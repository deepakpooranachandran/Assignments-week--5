...
test('Upload File without clicking Upload button', async ({ page }) => {
    ...
    page.locator("//input[@id='file-upload']").setInputFiles("Utils/FileUpload.docx")
...
test('Download file.json and assert download',async({page})=>{
    ...
    console.log('The web_local.json file is succesfully downloaded to the above downlaod folder')
